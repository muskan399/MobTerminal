                ...
                children: <Widget>[
                  Container(
                    ...
                    Container(
                      ...
                      obscureText: visible,
                      decoration: InputDecoration(
                        suffixIcon: IconButton(icon: visible ?Icon(Icons.visibility_off) : Icon(Icons.visibility),onPressed: (){
                          setState(() {
                            print(visible);
                            if(visible==true){
                            visible=false;
                 ...
                 Container(
                    ...
                    Container(
                      ...
                      child: Row(children: <Widget>[
                       ...
                       IconButton(icon: Image.network("https://raw.githubusercontent.com/muskan399/first/master/linkedin.png"),
                       onPressed: (){},
                       ),
                       IconButton(icon: Image.network("https://raw.githubusercontent.com/muskan399/first/master/fb.png"),
                       onPressed: (){},
                       ),
