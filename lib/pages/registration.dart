                 ...
                 Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Icon(Icons.email,color: Colors.green[300],),
                ...
                Material(
                 ...
                 child: MaterialButton(
                   ...
                   onPressed: () async{
                     ...
                     var a=await auth.createUserWithEmailAndPassword(email: email, password: password);
                      var f=FirebaseFirestore.instance;
                       var firebaseUser = auth.currentUser;
                       print(firebaseUser);
                      await f.collection("users").doc(firebaseUser.email).set({
                         "fname": fname,
                         "lname": lname
                      }
                       );
