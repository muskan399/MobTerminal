...
class _historyState extends State<history> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(backgroundColor: Colors.black,title: Text("History"),centerTitle: true,),
...
Container(
  height: 50,
     ...
     child: RaisedButton(child: Text("${b[index]}"),
     onPressed: (){
       var a1=b[index];
       print("a1 is $a1");
       Navigator.of(context).push(MaterialPageRoute(builder: (context) => cmd_history(d: a1)));
